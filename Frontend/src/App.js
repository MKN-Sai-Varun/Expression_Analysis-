...
function App() {
  ...
  const handleCounter = async () => {
    ...
    try {
      ...
      await axios.post("http://localhost:7000/update-counter", {
  ...
  return (
    <>
          ...
          <div id="loginPage">
            <form id="loginForm">
              ...
              <div className="submit-button">
                <button type="button" onClick={handleLogin} class="button">
                  Login
                </button>
              </div>
        ...
        <div id="question2">
          ...
          <div className="game">
            ...
            <div className="imgChoices">
              <button
                className="imgchoice"
                onClick={() => handleChoiceClick("Bear")}
                style={getChoiceStyle("Bear", false)}
              >
                <img src={images.bear} alt="Bear" />
              </button>
              <button
                className="imgchoice"
                onClick={() => handleChoiceClick("Lion")}
                style={getChoiceStyle("Lion", true)}
              >
                <img src={images.lion} alt="Lion" />
              </button>
              <button
                className="imgchoice"
                onClick={() => handleChoiceClick("Tiger")}
                style={getChoiceStyle("Tiger", false)}
              >
        ...
        <div id="question3">
          ...
          <div className="game">
            ...
            <div className="choices">
              <button
                className="choice"
                onClick={() => handleChoiceClick("Skill")}
                style={getChoiceStyle("Skill", true)}
              >
                Skill
              </button>
              <button
                className="choice"
                onClick={() => handleChoiceClick("Silk")}
                style={getChoiceStyle("Silk", false)}
              >
                Silk
              </button>
            </div>
        ...
        <div id="question4">
          ...
          <div className="game">
            ...
            <div className="imgChoices">
              <button
                className="imgchoice"
                onClick={() => handleChoiceClick("Leopard")}
                style={getChoiceStyle("Leopard", false)}
              >
                <img src={images.leapord} alt="Leopard" />
              </button>
              <button
                className="imgchoice"
                onClick={() => handleChoiceClick("Giraffe")}
                style={getChoiceStyle("Giraffe", false)}
              >
                <img src={images.giraffe} alt="Giraffe" />
              </button>
              <button
                className="imgchoice"
                onClick={() => handleChoiceClick("Zebra")}
                style={getChoiceStyle("Zebra", true)}
              >
        ...
        <div id="question5">
          ...
          <div className="game">
            ...
            <div className="choices">
              <button
                className="choice"
                onClick={() => handleChoiceClick("n")}
                style={getChoiceStyle("n", false)}
              >
                n
              </button>
              <button
                className="choice"
                onClick={() => handleChoiceClick("h")}
                style={getChoiceStyle("h", true)}
              >
                h
              </button>
            </div>
      ...
      {currentPage !== "login" &&
        currentPage !== "play" &&
        currentPage !== "end" &&
        currentPage !== "TimeUp" && <div className="score">Score: {score}</div>}
    </>
  );
}
export default App;
